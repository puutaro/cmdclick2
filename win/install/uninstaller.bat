...
:uninstall_package_in_ubuntu
	powershell -c "$base = (bash -c 'wslpath -u "%userprofile%"').Trim(); $base = $base -replace 'home','Users'; echo $base; bash ""$base/cmdclick/win/install/uninstaller_lib/exec_uninstall.sh"""
EXIT /B 0