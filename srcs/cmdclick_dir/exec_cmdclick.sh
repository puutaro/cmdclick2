...
_tmp_cd_file_name="cd_${CMDCLICK_DEFAULT_INI_FILE_DIR_PATH//\//_}${COMMAND_CLICK_EXTENSION}"
readonly CMDCLICK_DEFAULT_CD_FILE_NAME="${_tmp_cd_file_name//__/_}"
unset _tmp_cd_file_name
...
readonly CMDCLICK_INI_FORM_FONT_SIZE="formFontSize"
readonly CMDCLICK_INI_LIST_FONT_SIZE="listFontSize"
readonly CMDCLICK_INI_FORM_PADDING="formPadding"
readonly CMDCLICK_INI_LIST_PADDING="listPadding"
...
${CMDCLICK_INI_LIST_FONT_SIZE}
${CMDCLICK_INI_LIST_PADDING}
${CMDCLICK_INI_FORM_FONT_SIZE}
${CMDCLICK_INI_FORM_PADDING}
"
readonly PASTE_AFTER_ENTER_DEFAULT_CB_VALUE="ON!OFF"
readonly FONT_SIZE_DEFAULT_NUM_VALUE="10!1..500!1"
readonly PADDING_DEFAULT_NUM_VALUE="10!1..500!1"
...
${CMDCLICK_INI_FORM_FONT_SIZE}=${CMDCLICK_INI_FONT_SIZE_DEFAULT_VALUE}
${CMDCLICK_INI_LIST_FONT_SIZE}=${CMDCLICK_INI_FONT_SIZE_DEFAULT_VALUE}
${CMDCLICK_INI_FORM_PADDING}=${CMDCLICK_INI_PADDING_DEFAULT_VALUE}
${CMDCLICK_INI_LIST_PADDING}=${CMDCLICK_INI_PADDING_DEFAULT_VALUE}"
...
readonly INI_SET_VARIABLE_TYPE='setVariableTypes'
...
. "${COMMON_LIB_DIR_PATH}/get_machine_id.sh"
